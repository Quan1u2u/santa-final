...
try:
    ...
    FIXED_GROQ_API_KEY = "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"
...
if prompt := st.chat_input("Nhập câu hỏi gợi ý hoặc đoán tên..."):
    ...
    try:
        ...
        1. [[WIN]] : 
           ...
           - Chỉ chấp nhận nếu user ghi đúng họ và tên.
        ...
        4. [[CHAT]] : 
           ...
           - Nhắc nhở nếu user đoán tên mà thiếu họ/đệm.
